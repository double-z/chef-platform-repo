...
module EcHarness
  ...
  def platform_provision_attrs(node)
    @platform_provision_attrs ||= get_platform_provision_attrs(node)
  end

  def get_platform_provision_attrs(node)
    @platform_provision_attrs = {}
    @platform_provision_attrs['chef-platform'] = {}
    @platform_provision_attrs['chef-platform']['harness']      = node['harness']
    @platform_provision_attrs['chef-platform']['private-chef'] = privatechef_attributes
    @platform_provision_attrs['chef-platform']['analytics']    = analytics_attributes
    @platform_provision_attrs['chef-platform']['root_ssh']     = node['harness']['root_ssh'].to_hash
    @platform_provision_attrs['chef-platform']['cloud']        = cloud_attributes(node['harness']['provider'])
    @platform_provision_attrs['chef-platform']['osc-install']  = node['harness']['osc_install']
    @platform_provision_attrs['chef-platform']['osc-upgrade']  = node['harness']['osc_upgrade']
    @platform_provision_attrs
  end

    def do_get_platform_provision_attrs(node)
    @platform_provision = {}
    # @platform_provision_attrs['chef-platform'] = {}
    @platform_provision['harness']      = node['harness']
    @platform_provision['private-chef'] = privatechef_attributes
    @platform_provision['analytics']    = analytics_attributes
    @platform_provision['root_ssh']     = node['harness']['root_ssh'].to_hash
    @platform_provision['cloud']        = cloud_attributes(node['harness']['provider'])
    @platform_provision['osc-install']  = node['harness']['osc_install']
    @platform_provision['osc-upgrade']  = node['harness']['osc_upgrade']
    @platform_provision
  end
