...
#         mfp = machine_file "pivotal.pem" do
#           local_path "#{local_chef_server_cache_path}/#{server_file}"
#           machine new_platform_spec.chef_server_bootstrap_backend['fqdn']
#           action :nothing
#         end

#         mfwp = machine_file "webui_pub.pem" do
#           local_path "#{local_chef_server_cache_path}/#{server_file}"
#           machine new_platform_spec.chef_server_bootstrap_backend['fqdn']
#           action :nothing
#         end

#         mfpcs = machine_file "private-chef-secrets.json" do
#           local_path "#{local_chef_server_cache_path}/#{server_file}"
#           machine new_platform_spec.chef_server_bootstrap_backend['fqdn']
#           action :nothing
#         end

#         mfwpr = machine_file "webui_priv.pem" do
#           local_path "#{local_chef_server_cache_path}/#{server_file}"
#           machine new_platform_spec.chef_server_bootstrap_backend['fqdn']
#           action :nothing
#         end

#         mfa = machine_file "actions-source.json" do
#           local_path "#{local_chef_server_cache_path}/#{server_file}"
#           machine new_platform_spec.chef_server_bootstrap_backend['fqdn']
#           action :nothing
#         end

#         mfawpriv = machine_file "webui_priv.pem" do
#           local_path "#{local_chef_server_cache_path}/#{server_file}"
#           machine new_platform_spec.chef_server_bootstrap_backend['fqdn']
#           action :nothing
#         end
...
#         mfp.run_action(:download)
#         mfwp.run_action(:download)
#         mfpcs.run_action(:download)
#         mfwpr.run_action(:download)
#         mfa.run_action(:download)
#         mfawpriv.run_action(:download)
...
#       #####
#       #
#       # PRIVATE ACTION: _push_bootstrap_files
#       #
