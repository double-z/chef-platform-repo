default['chef_platform']['chef_server']['api_fqdn'] = "chefapi.ubuntu.local"
...
default['chef_platform']['nodes'] = [
  ...
  {
    "node_name" => "delivery-build3",
    "service" => "delivery",
    "fqdn" => "delivery-build3.ubuntu.vagrant",
    "ipaddress" => "33.33.33.30",
    "role" => "delivery_build",
    "bootstrap" => false,
    "machine_options" => {
      "vagrant_config" => {
